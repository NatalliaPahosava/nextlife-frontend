import Powerslap from '../assets/video/1.mp4'
  ...
  return (
    <div>
      ...
      <div className='container-login'>
        ...
        <input type='email' placeholder='Email' id=''onChange={e=>setForm({...form,email:e.target.value})} />
        <br />
        ...
        <a href='https://www.instagram.com/nextlife_usa_ny/'>
          <svg
